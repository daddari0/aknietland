...
export function ContactForm({ language }: ContactFormProps) {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 relative overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#0d2040] to-[#0e2a4f]">
      {/* Background blobs */}
      <div className="absolute top-0 right-0 w-[450px] h-[450px] rounded-full bg-[#1CA6D0]/12 blur-[90px]" />
      <div className="absolute bottom-0 left-0 w-[450px] h-[450px] rounded-full bg-[#3BB85E]/10 blur-[90px]" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 text-white/80 font-semibold text-sm">
                <span>{benefit}</span>
              </div>
            ))}
            ...
            <div className="space-y-3 pt-4 border-t border-white/10">
              <a href="tel:+77773626742" className="flex items-center gap-3 text-white/70 hover:text-white transition-colors group">
                <div className="w-10 h-10 rounded-2xl bg-white/10 flex items-center justify-center group-hover:bg-[#1CA6D0]/20 transition-colors">
                  <Phone size={18} className="text-[#1CA6D0]" />
                </div>
                <span className="font-semibold">+7 (777) 362-67-42</span>
              </a>
              <a href="tel:+77071819707" className="flex items-center gap-3 text-white/70 hover:text-white transition-colors group">
                <div className="w-10 h-10 rounded-2xl bg-white/10 flex items-center justify-center group-hover:bg-[#1CA6D0]/20 transition-colors">
                  <Phone size={18} className="text-[#1CA6D0]" />
                </div>
                <span className="font-semibold">+7 (707) 181-97-07</span>
              </a>
              <div className="pt-1">
                <p className="text-white/40 text-xs mb-2 font-semibold uppercase tracking-wider">{t.orWrite}</p>
                <a
                  href="https://wa.me/77773626742"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#3BB85E] hover:bg-[#2fa34f] text-white font-bold px-5 py-2.5 rounded-2xl shadow-lg hover:scale-105 transition-all text-sm"
                >
          ...
          {/* RIGHT: Form card */}
          <div className="glass-card rounded-[32px] p-8 lg:p-10 shadow-2xl">
            {submitted ? (
              /* ── Success state ── */
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 rounded-2xl bg-[#FAC315]/15 flex items-center justify-center">
                    <Sparkles size={18} className="text-[#b88a00]" />
                  </div>
                  <div>
                    <p className="text-xs font-black text-[#b88a00] uppercase tracking-wider">
                ...
                <div className="space-y-2">
                  <Label htmlFor="parent-name" className="text-gray-700 font-bold text-sm pl-1">
                    {t.nameLabel}
                  </Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="h-14 w-full rounded-2xl border-2 border-gray-200 focus-visible:ring-[#1CA6D0] focus-visible:border-[#1CA6D0] bg-gray-50 pl-11 pr-4 shadow-sm text-base text-gray-800 transition-all hover:border-gray-300"
                    />
                  </div>
                </div>
                ...
                {/* Phone field */}
                <div className="space-y-2">
                  <Label htmlFor="parent-phone" className="text-gray-700 font-bold text-sm pl-1">
                    {t.phoneLabel}
                  </Label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 pointer-events-none">
      ...
      <div className="wave-bottom">
        <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style={{ height: '64px' }}>
          <path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" fill="#050e1e" />
        </svg>
      </div>
    </section>
  );
